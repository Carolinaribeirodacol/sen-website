...
export const MobileNavbar = () => {
    ...
    return (
        <div
            className={cn(
                "fixed inset-0 top-24 z-50 grid h-[calc(100vh-4rem)] grid-flow-row auto-rows-max overflow-auto p-6 pb-32 shadow-md animate-in slide-in-from-bottom-80 md:hidden"
            )}
        >
